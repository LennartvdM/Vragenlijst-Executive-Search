    ...
    fields: [
      {
        ...
        conditional: {
          trigger: 'Ja',
          fields: [
            { type: 'number', name: 'streefcijfer_percentage', label: 'Streefcijfer', placeholder: 'bijv. 30', suffix: '%', compact: true, maxLength: 3 },
            { type: 'number', name: 'streefcijfer_jaar', label: 'Te behalen in', placeholder: 'bijv. 2026', compact: true, maxLength: 4 },
            {
              type: 'radio-cards',
