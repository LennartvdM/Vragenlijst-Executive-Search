                    ...
                    <table role="presentation" width="100%" cellpadding="0" cellspacing="0">
                      ...
                      <tr>
                        <td style="padding: 0 28px 8px;" align="center">
                          <!--[if mso]>
                          <v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="${surveyUrl}" style="height:42px;v-text-anchor:middle;width:220px;" arcsize="24%" strokecolor="#2c1162" fillcolor="#2c1162">
                            <w:anchorlock/>
                          ...
                          <table role="presentation" cellpadding="0" cellspacing="0">
                            <tr>
                              <td bgcolor="#2c1162" style="background:linear-gradient(135deg, #ae8cf4 0%, #2c1162 100%); border-radius:10px; box-shadow:0 4px 12px rgba(44,17,98,0.3);">
                      ...
                      <tr>
                        <td style="padding: 0 28px 24px;" align="center">
                          <a href="${previewUrl}" target="_blank" style="color:#473c5d; font-size:12px; text-decoration:underline;">${previewLinkText}</a>
                        </td>
                      </tr>
