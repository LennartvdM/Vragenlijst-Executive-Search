    ...
    <tr>
      <td align="center" style="padding: 40px 20px;">
        ...
        <table role="presentation" width="600" cellpadding="0" cellspacing="0" style="background-color:#ffffff; border-radius:16px; overflow:hidden; max-width:600px; box-shadow: 0 4px 24px rgba(17,17,98,0.08);">
          ...
          <!-- Top accent bar -->
          <tr>
            <td style="height:4px; background:linear-gradient(90deg, #8caef4 0%, #111162 100%); font-size:0; line-height:0;">&nbsp;</td>
          </tr>

          <!-- Header -->
          <tr>
            <td style="background-color:#111162; padding: 48px 40px 40px; text-align: center;">
              <table role="presentation" width="100%" cellpadding="0" cellspacing="0">
                <tr>
                  <td align="center" style="padding-bottom: 20px;">
                    ...
                    <table role="presentation" cellpadding="0" cellspacing="0" style="margin: 0 auto;">
                      <tr>
                        <td style="width:48px; height:48px; font-size:0; line-height:0;">
                ...
                <tr>
                  <td align="center">
                    <h1 style="margin:0; color:#ffffff; font-family:'Segoe UI', Helvetica, Arial, sans-serif; font-size:24px; font-weight:700; line-height:1.3; letter-spacing:-0.01em;">
                      Monitoring Cultureel Talent<br>naar de Top
                    </h1>
          ...
          <tr>
            <td style="padding: 44px 44px 36px;">
              <!-- Greeting -->
              <p style="margin:0 0 20px; color:#1d1d30; font-size:17px; font-weight:500; line-height:1.6;">
                Geachte ${naam},
              </p>

              <!-- Main text -->
              <p style="margin:0 0 32px; color:#3c3c5d; font-size:15px; line-height:1.7;">
                Wij vragen u de monitoring in te vullen v&oacute;&oacute;r <strong style="color:#111162; font-weight:700;">${deadline}</strong>.
              </p>

              <!-- Access code box -->
              <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="margin:0 0 32px;">
                <tr>
                  <td style="background:linear-gradient(135deg, #f1f4f8 0%, #e1e9f4 100%); border-radius:14px; border-left:4px solid #111162; padding:28px 28px 28px 32px; text-align:center;">
                    <p style="margin:0 0 10px; color:#7a7a96; font-size:12px; font-weight:600; text-transform:uppercase; letter-spacing:1.5px;">
                      Uw toegangscode
                    </p>
                    <p style="margin:0; color:#111162; font-size:32px; font-weight:700; letter-spacing:6px; font-family:'SF Mono','Fira Code','Courier New',monospace;">
                      ${code}
                    </p>
                  </td>
                </tr>
                    ...
                    <table role="presentation" cellpadding="0" cellspacing="0">
                      <tr>
                        <td style="background:linear-gradient(135deg, #8caef4 0%, #111162 100%); border-radius:12px;">
                          <a href="${surveyUrl}" target="_blank" style="display:inline-block; padding:16px 40px; color:#ffffff; text-decoration:none; font-size:16px; font-weight:600; letter-spacing:0.02em; font-family:'Segoe UI', Helvetica, Arial, sans-serif;">
              ...
              <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="margin:0 0 40px;">
                <tr>
                  <td align="center">
                    <a href="${previewUrl}" target="_blank" style="color:#8caef4; font-size:14px; font-weight:500; text-decoration:none; border-bottom:1px solid rgba(140,174,244,0.4);">
                      Bekijk het inkijkexemplaar &rarr;
                    </a>
                  </td>
                </tr>
              </table>
                ...
                <tr>
                  <td align="center">
                    <table role="presentation" width="80" cellpadding="0" cellspacing="0">
                      <tr>
                        <td style="height:2px; background:linear-gradient(90deg, transparent 0%, #e1e9f4 50%, transparent 100%); font-size:0; line-height:0;">&nbsp;</td>
                      </tr>
                    </table>
                  </td>
                </tr>
              ...
              <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="margin:0 0 28px;">
                <tr>
                  <td>
                    <p style="margin:0 0 14px; color:#111162; font-size:14px; font-weight:700; text-transform:uppercase; letter-spacing:0.5px;">
                      Praktisch
                    </p>
                    <table role="presentation" width="100%" cellpadding="0" cellspacing="0">
                      <tr>
                        <td style="padding:6px 0; color:#3c3c5d; font-size:14px; line-height:1.7;">
                          <span style="color:#8caef4; font-weight:700;">&#8226;</span>&nbsp;&nbsp;Duurt 20&#8211;30 minuten, u kunt tussendoor stoppen
                        </td>
                      </tr>
                      <tr>
                        <td style="padding:6px 0; color:#3c3c5d; font-size:14px; line-height:1.7;">
                          <span style="color:#8caef4; font-weight:700;">&#8226;</span>&nbsp;&nbsp;U kunt meerdere keren verzenden &#8212; de laatste versie telt
                        </td>
                      </tr>
                      <tr>
                        <td style="padding:6px 0; color:#3c3c5d; font-size:14px; line-height:1.7;">
                          <span style="color:#8caef4; font-weight:700;">&#8226;</span>&nbsp;&nbsp;Houd uw personeelscijfers bij de hand
                        </td>
                      </tr>
                      <tr>
                        <td style="padding:6px 0; color:#3c3c5d; font-size:14px; line-height:1.7;">
                          <span style="color:#8caef4; font-weight:700;">&#8226;</span>&nbsp;&nbsp;Uw voortgang is gekoppeld aan uw apparaat, niet aan uw code
                        </td>
                      </tr>
                    </table>
                  </td>
              ...
              <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="margin:0 0 32px;">
                <tr>
                  <td style="background-color:#f8f9fb; border-radius:12px; border:1px solid #e8ecf2; padding:22px 26px;">
                    <table role="presentation" width="100%" cellpadding="0" cellspacing="0">
                      <tr>
                        <td style="padding-bottom:10px;">
                          <span style="display:inline-block; background-color:#e1e9f4; border-radius:6px; padding:3px 10px; font-size:11px; font-weight:600; color:#7a7a96; text-transform:uppercase; letter-spacing:0.5px;">Privacy</span>
                        </td>
                      </tr>
                    </table>
                    <p style="margin:0 0 12px; color:#3c3c5d; font-size:13px; line-height:1.7;">
                      Uw antwoorden worden beveiligd opgeslagen in uw browser, lokaal op uw apparaat. Hierdoor kunt u tussendoor stoppen en later verdergaan, maar:
                    </p>
                    <table role="presentation" width="100%" cellpadding="0" cellspacing="0">
                      <tr>
                        <td style="padding:3px 0; color:#7a7a96; font-size:13px; line-height:1.6;">
              ...
              <!-- Contact -->
              <p style="margin:0 0 28px; color:#7a7a96; font-size:14px; line-height:1.6;">
                Bij vragen: ${contactPerson} via
                <a href="mailto:${contactEmail}" style="color:#111162; font-weight:500; text-decoration:none; border-bottom:1px solid rgba(17,17,98,0.3);">${contactEmail}</a>
              </p>

              <!-- Closing -->
              <p style="margin:0 0 4px; color:#3c3c5d; font-size:15px; line-height:1.6;">
                Met vriendelijke groet,
              </p>
              <p style="margin:0; color:#111162; font-size:15px; font-weight:700; line-height:1.6;">
                ${senderName}
              </p>
            </td>
          </tr>
          ...
          <!-- Footer -->
          <tr>
            <td style="background:linear-gradient(135deg, #f1f4f8 0%, #e1e9f4 100%); padding:24px 44px; text-align:center;">
              <p style="margin:0; color:#7a7a96; font-size:12px; line-height:1.6;">
                U ontvangt deze e-mail omdat uw organisatie deelneemt aan de<br>Monitoring Cultureel Talent naar de Top 2026.
              </p>
            </td>
          </tr>
