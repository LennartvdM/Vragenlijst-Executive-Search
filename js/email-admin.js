    ...
    <tr>
      <td align="center" style="padding: 40px 20px;">
        ...
        <table role="presentation" width="600" cellpadding="0" cellspacing="0" style="background-color:#ffffff; border-radius:16px; overflow:hidden; max-width:600px;">
          ...
          <!-- Header -->
          <tr>
            <td style="background-color:#111162; padding: 40px 40px 32px; text-align: center;">
              <table role="presentation" width="100%" cellpadding="0" cellspacing="0">
                ...
                <tr>
                  <td align="center">
                    <h1 style="margin:0; color:#ffffff; font-family:'Segoe UI', Helvetica, Arial, sans-serif; font-size:22px; font-weight:700; line-height:1.3;">
                      Monitoring Cultureel Talent<br>naar de Top
                    </h1>
                    <p style="margin:8px 0 0; color:rgba(255,255,255,0.6); font-size:14px; font-weight:400;">2026</p>
                  </td>
                </tr>
              </table>
            </td>
          ...
          <tr>
            <td style="padding: 40px 40px 32px;">
              ...
              <!-- Main text -->
              <p style="margin:0 0 28px; color:#3c3c5d; font-size:15px; line-height:1.7;">
                Wij vragen u de monitoring in te vullen v&oacute;&oacute;r <strong style="color:#1d1d30;">${deadline}</strong>.
              </p>

              <!-- Access code box -->
              <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="margin:0 0 28px;">
                <tr>
                  <td style="background-color:#e1e9f4; border-radius:12px; padding:24px; text-align:center;">
                    <p style="margin:0 0 8px; color:#7a7a96; font-size:13px; font-weight:500; text-transform:uppercase; letter-spacing:1px;">
                      Uw toegangscode
                    </p>
                    <p style="margin:0; color:#111162; font-size:28px; font-weight:700; letter-spacing:4px; font-family:'SF Mono','Fira Code','Courier New',monospace;">
                      ${code}
                    </p>
                  </td>
                </tr>
                    ...
                    <table role="presentation" cellpadding="0" cellspacing="0">
                      <tr>
                        <td style="background-color:#111162; border-radius:10px;">
                          <a href="${surveyUrl}" target="_blank" style="display:inline-block; padding:14px 32px; color:#ffffff; text-decoration:none; font-size:16px; font-weight:600; font-family:'Segoe UI', Helvetica, Arial, sans-serif;">
              ...
              <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="margin:0 0 36px;">
                <tr>
                  <td align="center">
                    <a href="${previewUrl}" target="_blank" style="color:#111162; font-size:14px; font-weight:500; text-decoration:underline;">
              ...
              <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="margin:0 0 24px;">
                <tr>
                  <td>
                    ...
                    <table role="presentation" width="100%" cellpadding="0" cellspacing="0">
                      <tr>
                        <td style="padding:4px 0; color:#3c3c5d; font-size:14px; line-height:1.6;">
                      ...
                      <tr>
                        <td style="padding:4px 0; color:#3c3c5d; font-size:14px; line-height:1.6;">
                          &#8226;&nbsp; Houd uw personeelscijfers bij de hand (totaal, top, subtop, per herkomst Buiten-Europa)
                        </td>
                      </tr>
                      <tr>
                        <td style="padding:4px 0; color:#3c3c5d; font-size:14px; line-height:1.6;">
                          &#8226;&nbsp; Uw voortgang is gekoppeld aan uw apparaat, niet aan uw code
                        </td>
                      </tr>
                    </table>
                  </td>
              ...
              <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="margin:0 0 28px;">
                <tr>
                  <td style="background-color:#f1f4f8; border-radius:10px; padding:20px 24px;">
                    <p style="margin:0 0 10px; color:#3c3c5d; font-size:14px; line-height:1.7;">
              ...
              <!-- Contact -->
              <p style="margin:0 0 24px; color:#7a7a96; font-size:14px; line-height:1.6;">
                Bij vragen: ${contactPerson} via
                <a href="mailto:${contactEmail}" style="color:#111162; text-decoration:underline;">${contactEmail}</a>
              </p>
              ...
              <p style="margin:0; color:#1d1d30; font-size:15px; font-weight:600; line-height:1.6;">
                ${senderName}
              </p>
            </td>
          </tr>
          ...
          <!-- Footer -->
          <tr>
            <td style="background-color:#e1e9f4; padding:20px 40px; text-align:center;">
