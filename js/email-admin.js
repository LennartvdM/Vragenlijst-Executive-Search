  ...
  function renderTable() {
    ...
    tbody.innerHTML = recipients.map(r => {
      ...
      <tr data-id="${r.id}" class="${rowClass}">
        ...
        <td class="ea-cell-email"><input type="text" inputmode="email" class="ea-inline-input" data-id="${r.id}" data-field="email" placeholder="E-mailadres" value="${esc(r.email)}" autocomplete="one-time-code"></td>
        <td class="ea-cell-name"><input type="text" class="ea-inline-input" data-id="${r.id}" data-field="name" placeholder="Naam organisatie" value="${esc(r.name)}" autocomplete="one-time-code"></td>
        <td class="ea-cell-code">${esc(r.code)}</td>
        <td>${renderStatus(r)}</td>
        <td>
