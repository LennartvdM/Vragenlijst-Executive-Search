...
function buildEmailHtml(naam, code, subject, surveyUrl, previewUrl, deadline, contactPerson, contactEmail, senderName, textFields) {
  ...
  var contactHtml = escHtml(contactResolved).replace(escHtml(vars.contactEmail), '<a href="mailto:' + escHtml(contactEmail) + '" style="color:#2c1162;font-weight:500;text-decoration:none;">' + escHtml(contactEmail) + '</a>');
  ...
  for (var j = 0; j < filteredLines.length; j++) {
    ...
    checklistHtml += '<tr><td style="padding:' + padding + ';color:#473c5d;font-size:13px;line-height:1.6;"><span style="color:#2c1162;font-weight:700;margin-left:-18px;margin-right:8px;">&#10003;</span>' + escHtml(filteredLines[j]) + '</td></tr>';
  }
  ...
  return '<!DOCTYPE html>' +
    ...
    '<h1 style="margin:0;color:#231d30;font-family:\'Inter\',\'Segoe UI\',Helvetica,Arial,sans-serif;font-size:24px;font-weight:600;line-height:1.3;letter-spacing:-0.3px;">' + heading + '</h1>' +
    '</td></tr>' +

    // Subtitle / intro
    '<tr><td style="padding:0 28px 24px;">' +
    '<p style="margin:0;color:#837a96;font-size:15px;line-height:1.55;letter-spacing:0.01em;">' + introText + '</p>' +
    '</td></tr>' +
    ...
    '<p style="margin:0;color:#2c1162;font-size:26px;font-weight:700;letter-spacing:5px;font-family:\'SF Mono\',\'Fira Code\',\'Courier New\',monospace;">' + escHtml(code) + '</p>' +
    '</td></tr></table></td></tr>' +
    ...
    '<a href="' + escHtml(previewUrl) + '" target="_blank" style="color:#473c5d;font-size:12px;text-decoration:none;opacity:0.7;">' + previewLinkText + '</a>' +
    '</td></tr>' +
    ...
    // Praktisch heading
    '<tr><td style="padding:20px 28px 10px;"><p style="margin:0;color:#231d30;font-size:14px;font-weight:600;">' + praktischHeading + '</p></td></tr>' +
    ...
    // Contact
    '<tr><td style="padding:0 28px 16px;"><p style="margin:0;color:#837a96;font-size:12px;line-height:1.6;">' + contactHtml + '</p></td></tr>' +
    ...
    '<p style="margin:0;color:#231d30;font-size:13px;font-weight:600;line-height:1.6;">' + escHtml(senderName) + '</p>' +
    '</td></tr>' +
    ...
    '<p style="margin:0;color:#837a96;font-size:11px;line-height:1.5;">' + footerText + '</p>' +
    '</td></tr></table>' +
