...
function buildEmailHtml(naam, code, subject, surveyUrl, previewUrl, deadline, contactPerson, contactEmail, senderName, textFields) {
  ...
  var contactHtml = escHtml(contactResolved).replace(escHtml(vars.contactEmail), '<a href="mailto:' + escHtml(contactEmail) + '" style="color:#1f1162;font-weight:500;text-decoration:none;">' + escHtml(contactEmail) + '</a>');
  ...
  for (var j = 0; j < filteredLines.length; j++) {
    ...
    checklistHtml += '<tr><td style="padding:' + padding + ';color:#423c5d;font-size:13px;line-height:1.6;"><span style="color:#1f1162;font-weight:700;margin-left:-18px;margin-right:8px;">&#10003;</span>' + escHtml(filteredLines[j]) + '</td></tr>';
  }
  ...
  return '<!DOCTYPE html>' +
    ...
    '<table role="presentation" width="600" cellpadding="0" cellspacing="0" style="max-width:600px;background-color:#fafbfc;border-radius:18px;box-shadow:0 8px 32px rgba(12,9,30,0.15),0 2px 8px rgba(12,9,30,0.1);">' +
    ...
    '<span style="display:inline-block;width:6px;height:6px;border-radius:50%;background:#1f1162;margin-right:4px;">&nbsp;</span>' +
    '<span style="display:inline-block;width:6px;height:6px;border-radius:50%;background:#b3b5d2;margin-right:4px;">&nbsp;</span>' +
    '<span style="display:inline-block;width:6px;height:6px;border-radius:50%;background:#b3b5d2;margin-right:4px;">&nbsp;</span>' +
    '<span style="display:inline-block;width:6px;height:6px;border-radius:50%;background:#b3b5d2;margin-right:4px;">&nbsp;</span>' +
    '<span style="display:inline-block;width:6px;height:6px;border-radius:50%;background:#b3b5d2;">&nbsp;</span>' +
    '</td></tr>' +

    // h1 heading
    '<tr><td style="padding:20px 28px 8px;">' +
    '<h1 style="margin:0;color:#201d30;font-family:\'Inter\',\'Segoe UI\',Helvetica,Arial,sans-serif;font-size:24px;font-weight:600;line-height:1.3;letter-spacing:-0.3px;">' + heading + '</h1>' +
    '</td></tr>' +

    // Subtitle / intro
    '<tr><td style="padding:0 28px 24px;">' +
    '<p style="margin:0;color:#7f7a96;font-size:15px;line-height:1.55;letter-spacing:0.01em;">' + introText + '</p>' +
    '</td></tr>' +

    // Code box — .option-card.selected
    '<tr><td style="padding:0 28px 24px;">' +
    '<table role="presentation" width="100%" cellpadding="0" cellspacing="0"><tr>' +
    '<td style="border:2px solid #1f1162;border-radius:10px;background-color:#f2f3f8;padding:20px;text-align:center;box-shadow:0 4px 16px rgba(31,17,98,0.15);">' +
    '<p style="margin:0 0 6px;color:#7f7a96;font-size:12px;font-weight:500;text-transform:uppercase;letter-spacing:1px;">' + codeLabel + '</p>' +
    '<p style="margin:0;color:#1f1162;font-size:26px;font-weight:700;letter-spacing:5px;font-family:\'SF Mono\',\'Fira Code\',\'Courier New\',monospace;">' + escHtml(code) + '</p>' +
    '</td></tr></table></td></tr>' +

    // CTA — .btn-primary
    '<tr><td style="padding:0 28px 8px;" align="center">' +
    '<table role="presentation" cellpadding="0" cellspacing="0"><tr>' +
    '<td style="background:linear-gradient(135deg,#9d9df4 0%,#1f1162 100%);border-radius:10px;box-shadow:0 4px 12px rgba(31,17,98,0.3);">' +
    ...
    '<a href="' + escHtml(previewUrl) + '" target="_blank" style="color:#423c5d;font-size:12px;text-decoration:none;opacity:0.7;">' + previewLinkText + '</a>' +
    '</td></tr>' +

    // Divider
    '<tr><td style="padding:0 28px;"><table role="presentation" width="100%" cellpadding="0" cellspacing="0"><tr><td style="border-top:1px solid #e4e5f4;font-size:0;">&nbsp;</td></tr></table></td></tr>' +

    // Praktisch heading
    '<tr><td style="padding:20px 28px 10px;"><p style="margin:0;color:#201d30;font-size:14px;font-weight:600;">' + praktischHeading + '</p></td></tr>' +
    ...
    '<td style="background:linear-gradient(135deg,#f2f3f8 0%,#e4e5f4 100%);border-left:3px solid #1f1162;border-radius:0 8px 8px 0;padding:12px 16px;font-size:13px;color:#423c5d;line-height:1.6;">' +
    privacyText +
    '</td></tr></table></td></tr>' +

    // Contact
    '<tr><td style="padding:0 28px 16px;"><p style="margin:0;color:#7f7a96;font-size:12px;line-height:1.6;">' + contactHtml + '</p></td></tr>' +
    ...
    '<p style="margin:0 0 4px;color:#423c5d;font-size:13px;line-height:1.6;">' + closingText + '</p>' +
    '<p style="margin:0;color:#201d30;font-size:13px;font-weight:600;line-height:1.6;">' + escHtml(senderName) + '</p>' +
    '</td></tr>' +
    ...
    '<p style="margin:0;color:#7f7a96;font-size:11px;line-height:1.5;">' + footerText + '</p>' +
    '</td></tr></table>' +
